...
(function($, ko, data){
	...
	$(function(){
        ...
        ko.applyBindings(vm);
        // console.log('http://localhost:8080/skiltree_service/index.php?/welcome/skilltree?user='+username);
        var parametros = {
            "user" : username,
        };
        ...
        $.ajax({
            data: parametros,
            url: 'http://localhost:8080/skiltree_service/index.php?/welcome/skilltree?',
            type: 'get',
            success:  function (response) {
                console.log(response);
                if(response.error == ""){
                    skilltree = response.user_skilltree;
